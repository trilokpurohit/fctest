...
public class CustomReporter extends CustomReporterListener {
	...
	private void startResultSummaryTable(String style) { 
		...
		m_out.println("<tr><td colspan='6'>Overall test suite completion : <b>"
				...
				+ sdf.format(date) + "</b><br/> Browser : <b>"+com.Init.SeleniumInit.browserName+"<t></t>"
				+ com.Init.SeleniumInit.browserVersion +  "</b><br/>OS: <b>"
				+ System.getProperty("os.name") + "</b><br/>Tested URL: <b>"
				+ com.Init.SeleniumInit.Url + "</b> <br/></td></tr>");
	...
	protected void endHtml(PrintWriter out) {
		out.println("<tr bgcolor='SkyBlue'><td align='right' colspan='6'><center><b><i>Report customized by INC </i><b><center></center></b></b></center></td></tr>");
